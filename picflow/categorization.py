...
Правила:
- ero-anime: эротика/NSFW в аниме или рисованном стиле
- ero-real: эротика/NSFW с реальными людьми или фотореалистикой
- standart-art: обычный арт или красивая картинка без выраженного мемного формата
- standart-meme: обычный мем/шутка/пикча, где формат не завязан на одном крупном объекте
- single-meme: мем, построенный вокруг одного персонажа/объекта/реакции как основной единицы постинга
